import Homepage_PO from '../../support/pageObjectModel/webdriver_uni/Homepage_PO'
import Contact_Us_PO from '../../support/pageObjectModel/webdriver_uni/Contact_Us_PO';
/// <reference types="cypress" />

describe("Test Contact Us form via WebdriverUni", () => {
Cypress.config('defaultCommandTimeout',20000) //For particular test suite
